    ...
    <div className="grid gap-4 lg:grid-cols-3">
        ...
        {f.shortPercentOfFloat !== null ? (
          <table className="w-full text-xs tabular">
            <tbody>
              ...
              <Row label="Days to Cover" value={f.shortRatio !== null ? f.shortRatio.toFixed(1) + 'd' : '—'} />
              {f.sharesShort && f.sharesShortPriorMonth && f.sharesShortPriorMonth > 0 && (() => {
      ...
      <div>
        ...
        {(f.institutionsPercentHeld !== null || f.insidersPercentHeld !== null) ? (
          <table className="w-full text-xs tabular">
            <tbody>
              {f.institutionsPercentHeld !== null && (
